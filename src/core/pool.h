...
namespace TEngine::Core {
	...
	private:
		...
		entity m_entity;
	public:
		ComponentPtr(ComponentAllocator<T>& a, entity e)
	...
	template<typename T>
	class ComponentAllocator : public IDerivedAllocator {
		struct FreeBlock {};
		struct LinkedBlock {
		...
		private:
			...
			Pool* m_pool = nullptr;
		public:
			Iterator(ComponentAllocator& a, Pool* pool)
	...
	public:
		ComponentAllocator(IRootAllocator& a) : IDerivedAllocator(a) {}
